...
class AndroidYowsupEnv(YowsupEnv):
    ...
    _MD5_CLASSES = "3jYxFPSrhqjabEm5b2sXhA==" # _MD5_CLASSES = "ziYneeSZm5qExsEFX/AoMQ==" #_MD5_CLASSES = "ry9Xz6kVioQctwA3G9z62Q=="
    _KEY = "eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A="

    _VERSION = "2.17.279" # _VERSION = "2.17.254" #_VERSION = "2.12.556"
    _OS_NAME = "Android"
    _OS_VERSION = "4.3"
    _DEVICE_NAME = "armani"
